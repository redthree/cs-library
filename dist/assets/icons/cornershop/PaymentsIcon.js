...
function (_PureComponent) {
  _inherits(PaymentsIcon, _PureComponent);

  function PaymentsIcon() {
    _classCallCheck(this, PaymentsIcon);

    return _possibleConstructorReturn(this, _getPrototypeOf(PaymentsIcon).apply(this, arguments));
  }

  _createClass(PaymentsIcon, [{
    key: "render",
